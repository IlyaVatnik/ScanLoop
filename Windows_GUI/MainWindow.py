...
# =============================================================================
    ...
    def on_pushButton_set_hardware_ports(self):
        ...
        from Windows_GUI.UIs.hardware_dialogUI import Ui_Dialog
...
#            self.OSA.set_range(stop_wavelength=float(Maximum))
    ...
    def on_pushButton_set_analyzer_parameters(self):
        ...
        from Windows_GUI.UIs.analyzer_dialogUI import Ui_Dialog
    ...
    def on_pushButton_set_spectral_processor_parameters(self):
        ...
        from Windows_GUI.UIs.processing_dialogUI import Ui_Dialog
        dialog = QDialog()
        ui = Ui_Dialog()
        ui.setupUi(dialog)
    ...
    def on_pushButton_set_scanning_parameters(self):
        ...
        from Windows_GUI.UIs.scanning_dialogUI import Ui_Dialog
        dialog = QDialog()
        ui = Ui_Dialog()
        ui.setupUi(dialog)
        set_widget_values(dialog,d)
